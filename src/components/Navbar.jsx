  ...
  <div className='top-0 left-0  right-0 absolute z-10 w-full '>
    ...
    <img onClick={()=>setShowMobileMenu(false)} src="./cross_icon.svg" className='z-27 hover:scale-110 cursor-pointer w-8 md:hidden ' alt="" />
      ...
      <ul className='z-25 flex flex-col w-full text-center  '>
          <a onClick={()=>setShowMobileMenu(false)} className="hover:text-blue-700 mb-2 hover:font-bold text-sm" href='#Home' >HOME</a>
          <a onClick={()=>setShowMobileMenu(false)} className="hover:text-blue-700 mb-2 hover:font-bold  text-sm" href='#Feature' >FEATURES</a>
          <a onClick={()=>setShowMobileMenu(false)} className="hover:text-blue-700 mb-2 hover:font-bold  text-sm" href='#Pricing' >PRICING</a>
          <a onClick={()=>setShowMobileMenu(false)} className="hover:text-blue-700 mb-2 hover:font-bold text-sm" href='#Download' >DOWNLOAD</a>
          <a onClick={()=>setShowMobileMenu(false)} className="hover:text-blue-700 mb-2 hover:font-bold text-sm" href='#Contact'>CONTACT</a> 
      </ul>
